# Adapted for package-local imports and device placement. See LICENSE.
import functools
...
from .resnet import ResidualBlock_noBN, ResnetBlock
from .unet_parts import UnetSkipConnectionBlock
